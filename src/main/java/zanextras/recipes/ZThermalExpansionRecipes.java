...
public class ZThermalExpansionRecipes {
	...
	public static class LightOreRecipes {
		public static void init() {
			...
			ThermalExpansionHelper.addPulverizerRecipe(1000,
					...
					new ItemStack(ItemHelper.getItemFromStack(TFItems.itemMaterial.dustSilver), 5, 66));
		}
	}
	...
	/*public static class MagmaCrucibleRecipes {
		public static void init() {
			...
			ThermalExpansionHelper.addCrucibleRecipe(1500,
					new ItemStack(ZaneItems.raditeIngot, 1),
					new FluidStack(ZaneBlocks.radite, 250));
			
			// Molten Radite
			ThermalExpansionHelper.addCrucibleRecipe(3000,
					new ItemStack(ZaneBlocks.raditeBlock, 1),
					new FluidStack(ZaneBlocks.radite, 2250));
		}
	}
	...
	public static class TransposerRecipes {
		public static void init() {
			// Radite Bucket
			ThermalExpansionHelper.addTransposerFill(1500,
					new ItemStack(Items.bucket, 1),
					new ItemStack(ZaneItems.raditeBucket, 1),
					new FluidStack(ZaneBlocks.radite, 1000), true);
