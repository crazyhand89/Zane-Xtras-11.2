...
public class ZaneSword extends ItemSword {
	
	protected int amplifier1 = 1;
	protected int amplifier2 = 1;
	protected int amplifier3 = 1;
	
	public ZaneSword(ToolMaterial material, String name) {
		super(material);
	...
	public ZaneSword(ToolMaterial material,
	...
	public void getSubItems(Item itemIn, CreativeTabs tab,
		...
		//Emerald
		if (enchantTool.isItemEqual(new ItemStack(ZaneItems.emeraldSword))){
			enchantTool.addEnchantment(Enchantments.LOOTING, amplifier1);
			enchantTool.addEnchantment(Enchantments.SHARPNESS, amplifier2);
		}
		
		//Skyium
		if (enchantTool.isItemEqual(new ItemStack(ZaneItems.skyiumSword))){
