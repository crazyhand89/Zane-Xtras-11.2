...
public class ZaneCheeseWheel extends Block
{
    ...
    protected ZaneCheeseWheel()
    {
        super(Material.CAKE);
        this.setDefaultState(this.blockState.getBaseState().withProperty(BITES, Integer.valueOf(0)));
        this.setTickRandomly(true);
		this.setRegistryName(ModInfo.MODID + "_" + "cheesewheel");
		this.setUnlocalizedName(ModInfo.MODID + "_" + "cheesewheel");
